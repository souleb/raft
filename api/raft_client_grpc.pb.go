...
type ApplyEntryClient interface {
	...
	ApplyEntry(ctx context.Context, in *Entry, opts ...grpc.CallOption) (*ApplyResponse, error)
}
...
func (c *applyEntryClient) ApplyEntry(ctx context.Context, in *Entry, opts ...grpc.CallOption) (*ApplyResponse, error) {
...
type ApplyEntryServer interface {
	// RequestVote is called by candidates to gather votes.
	ApplyEntry(context.Context, *Entry) (*ApplyResponse, error)
...
func (UnimplementedApplyEntryServer) ApplyEntry(context.Context, *Entry) (*ApplyResponse, error) {
...
func _ApplyEntry_ApplyEntry_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ApplyEntryServer).ApplyEntry(ctx, req.(*Entry))
	}
